                ...
                <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                    <div className="mb-4">
                        <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                            ...
                            <p className="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400">Tanya kami melalui form ini
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="grid md:grid-cols-2">
                            <div className="h-full pr-6">
                                <p className="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                                    Untuk Bertanya lebih lanjut, atau ingin mendaftar kontak kami melalui form ini, nanti akan kami hubungi
                                </p>
                            ...
                            <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                                <h2 className="mb-4 text-2xl font-bold dark:text-white">Ingin segera mulai ?</h2>
                                <form id="contactForm">
                                    <div className="mb-6">
